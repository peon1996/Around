...
const (
	...
	POST_TYPE   = "post"
	DISTANCE    = "200km"
	ES_URL      = "http://34.73.141.84:9200"
	BUCKET_NAME = "mxy-around-bucket"
	// ENABLE_BIGTABLE = true
	// BT_INSTANCE     = "around-post"
	// PROJECT_ID      = "around2-228215"
	API_PREFIX = "/api/v1"
)
...
// 	bt_client, err := bigtable.NewClient(ctx, PROJECT_ID, BT_INSTANCE, option.WithCredentialsFile("Around2-2f59a6e87459.json"))
// 	if err != nil {
// 		panic(err)
// 	}
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	// Creates a client.
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("Around2-2f59a6e87459.json"))
	if err != nil {
		return nil, err
	}
